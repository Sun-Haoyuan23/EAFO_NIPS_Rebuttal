...
no_dist = False
no_pretrain = True
note = 'dataset: cifar100 | model: convnext_tiny | output_dir: ./experiments_300epoch/cifar100/convnext_tiny/silu'
num_workers = 4
optimizer = 'adamw'
output_dir = './experiments_300epoch/cifar100/convnext_tiny/silu'
