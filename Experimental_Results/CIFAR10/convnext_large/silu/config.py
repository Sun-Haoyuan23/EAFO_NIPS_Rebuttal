...
no_dist = False
no_pretrain = True
note = 'dataset: cifar10 | model: convnext_large | output_dir: ./experiments_300epoch/cifar10/convnext_large/silu'
num_workers = 4
optimizer = 'adamw'
output_dir = './experiments_300epoch/cifar10/convnext_large/silu'
