...
import os
# Setting the number of GPUs for experiments
os.environ["CUDA_VISIBLE_DEVICES"] = "2,3,4,5"

from engine import evaluate, train_one_epoch
from reconstruction import build_criterion, build_dataset, build_model, build_optimizer, build_scheduler
from reconstruction.utils.io import checkpoint_saver, checkpoint_loader, variables_loader, variables_saver
from reconstruction.utils.misc import makedirs, init_distributed_mode, init_seeds, is_main_process


def get_args_parser():
    parser = argparse.ArgumentParser('A Method on Searching Better Activation Functions', add_help=False)
...
def main(args):
    ...
    if args.eval:
        if  args.config=='/home/data_0/shy_23/EAFO-Image_classification/configs/crrelu.py' and args.model=='deit_base_patch4_32':
           test_stats, evaluator, hyper = evaluate(
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('EAFO Method', parents=[get_args_parser()])
